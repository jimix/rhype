...
const hcall_vec_t hcall_vec6000[] = {
	...
	[HEID2X(H_SET_SPR)]		= h_set_spr,
	[HEID2X(H_CREATE_VM_CLASS)]	= h_create_vm_class,
	[HEID2X(H_DESTROY_VM_CLASS)]	= h_destroy_vm_class,
	[HEID2X(H_VM_CLASS_OP)]		= h_vm_class_op,
	[HEID2X(H_VRFID)]		= h_vrfid,
	[HEID2X(H_SYNC_VM_CLASS)]	= h_sync_vm_class,
