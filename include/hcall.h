...
enum {
	...
	H_COUNTER_FREEZE  = 0x5000,
	H_COUNTER_SET	  = 0x5001,
	H_COUNTER_THAW    = 0x5002,
	H_COUNTER_GET	  = 0x5003,
};
...
#define H_MSR	0
extern sval hcall_set_spr(uval *retvals, uval reg, uval val);

#define H_VM_CLASS_LINEAR		0
#define H_VM_CLASS_REFLECT		1
#define H_VM_CLASS_TABLE		2

#define H_VMC_REFLECT_ENTER		1
#define H_VMC_CURR_AGE			2
#define H_VMC_CURR_GEN			3
#define H_VMC_TOGGLE_DEBUG		4
...
extern sval hcall_destroy_vm_class(uval *retvals, uval id);
extern sval hcall_vm_class_op(uval *retvals, uval id,
			      uval arg1, uval arg2, uval arg3, uval arg4);

extern sval hcall_vrfid(uval *retvals, uval restore_idx, uval new_dec);
extern sval hcall_sync_vm_class(uval *retvals);
