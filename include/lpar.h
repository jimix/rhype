...
/* Apple Mode */
#define H_SET_SPR		0x60c0
#define H_CREATE_VM_CLASS	0x60c4
#define H_VM_CLASS_OP		0x60c8
#define H_VRFID			0x60cc
#define H_SYNC_VM_CLASS		0x6070
#define H_DESTROY_VM_CLASS	0x6074
