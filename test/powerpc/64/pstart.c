		  ...
		  uval ofd)
{
	...
	stack = entry - OF_STACK_SIZE; /* 32k stack */
	memset((void*)stack, 0, OF_STACK_SIZE);
	...
	asm volatile ("mtctr %[pc]\n\t"
		      "bctr\n\t"::
		      [pc] "r" (lf->va_entry & ~(0xfULL << 60)),
		      "r" (r3),
		      "r" (r4),
		      "r" (r5),
		      "r" (r6),
